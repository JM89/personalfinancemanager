...
- [Personal Finance Manager](#personal-finance-manager)
  - [General Architecture \& Technologies](#general-architecture--technologies)
    - [Overview](#overview)
  - [Getting Started](#getting-started)
    - [Pre-requisites](#pre-requisites)
      - [Tools](#tools)
      - [Changes on hosts file](#changes-on-hosts-file)
      - [GitHub Package Access](#github-package-access)
      - [Local keycloak secrets](#local-keycloak-secrets)
      - [Shared infrastructure](#shared-infrastructure)
    - [Starting the backend services \& dependencies](#starting-the-backend-services--dependencies)
    - [Debug the APIs](#debug-the-apis)
