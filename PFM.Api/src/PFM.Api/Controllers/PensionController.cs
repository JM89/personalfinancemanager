...
namespace PFM.Api.Controllers
{
    ...
    public class PensionController(IPensionApi api) : ControllerBase
    {
        ...
        public async Task<ApiResponse> Post(string userId, [FromBody]PensionSaveRequest request)
        {
            return await api.Create(userId, request);
        }
        
        [HttpPut("Edit/{id}")]
        public async Task<ApiResponse> Put(Guid id, [FromBody]PensionSaveRequest request)
        {
