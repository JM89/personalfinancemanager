...
namespace PersonalFinanceManager.Services.Automapper
{
    public class ModelToDTOMapping : Profile
    {
        public ModelToDTOMapping()
        {
            ...
            CreateMap<Models.Currency.CurrencyEditModel, PFM.Bank.Api.Contracts.Currency.CurrencyDetails>();
            CreateMap<Models.Account.AccountEditModel, PFM.Bank.Api.Contracts.Account.AccountDetails>();
            ...
            CreateMap<Models.Bank.BankEditModel, PFM.Bank.Api.Contracts.Bank.BankDetails>();
            ...
            CreateMap<Models.Country.CountryEditModel, PFM.Bank.Api.Contracts.Country.CountryDetails>();
