...
namespace PersonalFinanceManager.Services
{
    public class IncomeService: IIncomeService
    {
        public void CreateIncomes(List<IncomeEditModel> models)
        {
            ...
            {
                var dto = models.Select(AutoMapper.Mapper.Map<PersonalFinanceManager.Api.Contracts.Income.IncomeDetails>).ToList();
        ...
        public void CreateIncome(IncomeEditModel model)
        {
            using (var httpClient = new HttpClientExtended())
            {
                var dto = AutoMapper.Mapper.Map<PersonalFinanceManager.Api.Contracts.Income.IncomeDetails>(model);
        ...
        public IList<IncomeListModel> GetIncomes(int accountId)
        {
            ...
            using (var httpClient = new HttpClientExtended())
            {
                var response = httpClient.GetList<PersonalFinanceManager.Api.Contracts.Income.IncomeList>($"/Income/GetList/{accountId}");
        ...
        public IncomeEditModel GetById(int id)
        {
            ...
            using (var httpClient = new HttpClientExtended())
            {
                var response = httpClient.GetSingle<PersonalFinanceManager.Api.Contracts.Income.IncomeDetails>($"/Income/Get/{id}");
